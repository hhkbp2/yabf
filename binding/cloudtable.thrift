...
namespace java com.duowan.cloudtable.thrift.generated
namespace cpp duowan.cloudtable.thrift
namespace rb Duowan.CloudTable.Thrift
namespace py cloudtable
namespace perl cloudtable
namespace go cloudtable
 ...
 * in a CloudTable table by column family and optionally
...
struct TGet {
  ...
  7: optional map<string, binary> attributes
...
struct TPut {
  ...
  2: required list<TColumnValue> columnValues
  3: optional i64 timestamp,
  5: optional map<string, binary> attributes,
...
struct TDelete {
  ...
  6: optional map<string, binary> attributes,
...
struct TIncrement {
  ...
  4: optional map<string, binary> attributes,
...
struct TAppend {
  ...
  3: optional map<string, binary> attributes,
...
struct TScan {
  ...
  9: optional map<string, binary> attributes
  10: optional TAuthorization authorizations
  11: optional i32 reversed=0
}
 ...
 * to the Cloudtable gateway. Also used to return more general errors.
 */
exception TIOError {
...
service TCloudTableService {

  /**
   * authenticate using username and passwd
   *
   * @return true if authentication success, false if failed
   */
  bool authenticate(
    /** the username */
